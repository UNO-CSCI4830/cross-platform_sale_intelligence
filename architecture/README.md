...
* Modular monolith is an architecture type that comprehends the "all-in-one" approach with a modular organization. It gives the developer the flexibility and scalability in developing a software. More information [here](https://www.geeksforgeeks.org/system-design/what-is-a-modular-monolith/)
